...
namespace RobotFactory.Workers._4.MountArms
{
    public class RobotConstructionMountArmsWorker : BaseRobotConstructionWorker<RobotConstructionMountArmsMessage>
    {
        private readonly ILogger<RobotConstructionMountArmsWorker> _logger;

        public RobotConstructionMountArmsWorker(ILogger<BaseRobotConstructionWorker<RobotConstructionMountArmsMessage>> logger, IBaseWorkerQueueConsumer<RobotConstructionMountArmsMessage> queueConsumer, IBaseWorkerQueuePublisher queuePublisher, IConfiguration configuration, IRobotComponentsRepository robotComponentsRepository, IRobotRepository robotRepository, ILogger<RobotConstructionMountArmsWorker> logger1)
