...
{
    public class RobotConstructionMountHeadWorker : BaseRobotConstructionWorker<RobotConstructionMountHeadMessage, RobotConstructionMountArmsMessage>
    {
        private readonly ILogger<RobotConstructionMountHeadWorker> _logger;

        public RobotConstructionMountHeadWorker(
            ILogger<BaseRobotConstructionWorker<RobotConstructionMountHeadMessage, RobotConstructionMountArmsMessage>> logger,
            IBaseWorkerQueueConsumer<RobotConstructionMountHeadMessage> queueConsumer,
            IBaseWorkerQueuePublisher<RobotConstructionMountArmsMessage> queuePublisher, IConfiguration configuration,
            IRobotComponentsRepository robotComponentsRepository, IRobotRepository robotRepository,
            ILogger<RobotConstructionMountHeadWorker> logger1) : base(logger, queueConsumer, queuePublisher,
