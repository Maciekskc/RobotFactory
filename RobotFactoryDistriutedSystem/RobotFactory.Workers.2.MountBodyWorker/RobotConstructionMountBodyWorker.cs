...
namespace RobotFactory.Workers._2.MountBodyWorker
{
    public class RobotConstructionMountBodyWorker : BaseRobotConstructionWorker<RobotConstructionMountBodyMessage>
    {
        private readonly ILogger<RobotConstructionMountBodyWorker> _logger;

        public RobotConstructionMountBodyWorker(ILogger<BaseRobotConstructionWorker<RobotConstructionMountBodyMessage>> logger, IBaseWorkerQueueConsumer<RobotConstructionMountBodyMessage> queueConsumer, IBaseWorkerQueuePublisher queuePublisher, IConfiguration configuration, IRobotComponentsRepository robotComponentsRepository, IRobotRepository robotRepository, ILogger<RobotConstructionMountBodyWorker> logger1)
