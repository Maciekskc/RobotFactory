...
{
    public class RobotConstructionMountLegsWorker : BaseRobotConstructionWorker<RobotConstructionMountLegsMessage, FinalizeRobotConstructionMessage>
    {
        private readonly ILogger<RobotConstructionMountLegsWorker> _logger;

        public RobotConstructionMountLegsWorker(
            ILogger<BaseRobotConstructionWorker<RobotConstructionMountLegsMessage, FinalizeRobotConstructionMessage>> logger,
            IBaseWorkerQueueConsumer<RobotConstructionMountLegsMessage> queueConsumer,
            IBaseWorkerQueuePublisher<FinalizeRobotConstructionMessage> queuePublisher, IConfiguration configuration,
            IRobotComponentsRepository robotComponentsRepository, IRobotRepository robotRepository,
            ILogger<RobotConstructionMountLegsWorker> logger1) : base(logger, queueConsumer, queuePublisher,
